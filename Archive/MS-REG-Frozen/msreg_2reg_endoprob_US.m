...
fig=figure; clf;
l1=plot(dates(sd:ed),p_reg2(sd:ed),'r-','DisplayName','p(bad regime) filtered'); hold on;
l2=plot(dates(sd:ed),p_reg2_sim(sd:ed),'b--','DisplayName','p(bad regime) simulated');
rr = recessionplot;
...
%l3=plot(xi_apr,pdf_apr,'Color',colors3(8,:),'LineWidth', 3,'DisplayName',['April-2020 ']); hold on;
...
%l1=plot(xi_dec,pdf_dec,'Color',colors(8,:),'LineWidth', 3,'DisplayName',['December-2020 ']);
l4=plot(xi_apr21,pdf_apr21,'Color',colors(60,:),'LineWidth', 3,'DisplayName',['April-2021 ']);
...
fig=figure;
hold on
l1=plot(xi_apr21,pdf_apr21,'k-','LineWidth', 4,'DisplayName',['December-2020 ']);
