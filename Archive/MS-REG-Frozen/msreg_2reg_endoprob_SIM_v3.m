    ...
    if exist([sim_folder 'results_iterated.mat'],'file')==2
        ...
        for jj=1:size(y_mat,2)
            ...
            parfor dd=1:nParamDraws
                for uu=1:nDraws
                    y_temp = [y_mat(example_draw,jj);NaN(12,1)];
                    f_temp = [Res_iterated.FF(example_draw,jj);NaN(12,1)];
                    m_temp = [Res_iterated.MF(example_draw,jj);NaN(12,1)];
                    s_temp = [st_mat(example_draw,jj);NaN(12,1)];
        ...
        if exist([sim_folder 'results_direct.mat'],'file')==2
            ...
            for jj=13:size(y_mat,2)
                ...
                parfor dd=1:nParamDraws
                    for uu=1:nDraws
                        y_temp = [y_mat(example_draw,jj);NaN(12,1)];
                        f_temp = [Res_iterated.FF(example_draw,jj-12:jj)];
                        m_temp = [Res_iterated.MF(example_draw,jj-12:jj)];
                        s_temp = [st_mat(example_draw,jj-12);NaN(12,1)];
