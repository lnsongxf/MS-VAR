...
function [dY_sim_1,dY_sim_2, dY_sim, dY_sim_weighted] = fPredictiveDist_2reg_endoprob(MF,FF,TR,myparams,pnames, p_reg1_filtered, p_reg2_filtered,prob_reg2_new, nDraws,normal)
