...
%load data
[db, db_full,startdb,enddb,tex] = data_new(datafilename,sheetuse,start_date,end_date,ctry);
...
hleg = legend([l1 l3 l4 l6 l7],'Orientation','Vertical','Location','NW','interpreter','Latex');legend boxoff;
