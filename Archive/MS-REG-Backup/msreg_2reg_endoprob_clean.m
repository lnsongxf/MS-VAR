...
dario = 1; % =1 if Dario test 

% Model label
if dario ==0
    model_label = ['_const_' num2str(const) '_normal_20201108_' num2str(normal)];
elseif dario ==1
    model_label = ['_const_' num2str(const) '_normal_20201108_dario_' num2str(normal)];
end
...
if saveit==1
    print('-dpdf',fig,[fig_folder 'Mar_Oct_2020_dario'],'-bestfit');
    %saveas(fig,sprintf('%s.png',[fig_folder 'DensityQR']));
end
