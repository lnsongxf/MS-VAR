...
s=find(Dates==datetime(start_date,'InputFormat','yyyy-QQQ'));
e=find(Dates==datetime(end_date,'InputFormat','yyyy-QQQ'));

e_data = find(Dates==datetime('2022-Q1','InputFormat','yyyy-QQQ'));
...
%
startdb = [num2str(year(datetime(start_date,'InputFormat','yyyy-QQQ'))) 'Q' num2str(quarter(datetime(start_date,'InputFormat','yyyy-QQQ')))];
if opt.dir_or_it ==1
    enddb   = [num2str(year(datetime(Dates(e-hh+1),'InputFormat','yyyy-QQQ'))) 'Q' num2str(quarter(datetime(Dates(e-hh+1),'InputFormat','yyyy-QQQ')))];
elseif opt.dir_or_it ==2
    enddb   = [num2str(year(datetime(Dates(e),'InputFormat','yyyy-QQQ'))) 'Q' num2str(quarter(datetime(Dates(e),'InputFormat','yyyy-QQQ')))];
end
