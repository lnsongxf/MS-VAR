...
function [y_out,y_out_1,y_out_2,s_out] = simulate_IteratedFull_companion(st_temp,f_temp,m_temp,gdp_temp,param,opt)
...
for tt=1:nsim
    ...
    % Danilo and Francesca - Dec 10, 2021
    gdp_temp = Ynext((3:nvars:(nlags*nvars)),tt);
    st_temp = s_out(tt);
