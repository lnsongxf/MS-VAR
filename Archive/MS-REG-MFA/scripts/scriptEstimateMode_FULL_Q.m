...
%         options = optimset('OptimalityTolerance',1e-12,'ConstraintTolerance',1e-12);
%         sv=estimate(sv0,db,{startdb,enddb},prior,restrictions,'fminunc',false,'optimset',options);
