...
if dir_or_it ==1
    ...
    lin_restr={
        ...
        %----------------------------------
        'a1(3,GDPGH)=0' % No effect of GDP (t-1)
        'a2(3,GDPGH)=0' % No effect of GDP (t-2)

        'a1(3,FF)=0'    % No effect of FF (t-1)                
        'a2(3,FF)=0'    % No effect of FF (t-2)
        
        'a1(3,MF)=0'    % No effect of MF (t-1) 
        'a2(3,MF)=0'    % No effect of MF (t-2)
...
elseif dir_or_it ==2
    ...
    lin_restr={
        ...
        'a1(1,GDPG)=0'  % No effect of GDP
        'a2(1,GDPG)=0'  % No effect of GDP
        
        
        % second equation or "macroeconomic factor" equation
        %-----------------------------------
        'a0(2,GDPG)=0'  % No contemporaneous effect of GDP
        'a1(2,GDPG)=0'  % No effect of GDP (t-1)
        'a2(2,GDPG)=0'  % No effect of GDP (t-2)

        'a0(2,FF)=0'    % No contemporaneous effect of FF

        % third equation or "GDP Growth" equation
        %----------------------------------
        'a1(3,GDPG)=0' % No effect of GDP (t-1)
        'a2(3,GDPG)=0' % No effect of GDP (t-2)
