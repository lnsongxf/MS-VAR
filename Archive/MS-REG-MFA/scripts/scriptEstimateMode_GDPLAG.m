...
elseif dir_or_it ==2
    ...
    lin_restr={
        ...
        'a1(1,GDPG)=0'  % No lagged effect of GDP
        'a1(1,MF)=0'    % No lagged effect of MF
        'a0(1,MF)=0'    % No lagged effect of MF
        % second equation or "macroeconomic factor" equation
        %-----------------------------------
        'a0(2,GDPG)=0'  % No contemporaneous effect of GDP
        'a1(2,GDPG)=0'  % No lagged effect of GDP
        'a1(1,FF)=0'    % No lagged effect of FF
        'a0(2,FF)=0'    % No contemporaneous effect of FF
        
        
        % third equation or "GDP Growth" equation
        %----------------------------------
        %'a1(3,GDPG)=0' % No lagged effect of GDP
        'a1(3,FF)=0'    % No lagged effect of FF
        'a1(3,MF)=0'    % No lagged effect of MF
        };
end
