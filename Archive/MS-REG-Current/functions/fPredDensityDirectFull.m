...
%
%------------------------------------------------------------------
function [out,pden_mat] = fPredDensityDirectFull(sv,params_in,FF,MF,GDP,trend_fit,opt,temp)
        ...
        for tt=1:tperiods
            ...
            if tt<=opt.hh
                ...
                elseif strcmp(temp,'forecastst')
                    ...
                    st_sim(tt) = st_sim_temp(opt.hh-1);
            ...
            % Simulate GDP(t+1,t+1+h) [Changed by PCB 11/19]
