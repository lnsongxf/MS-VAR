function out = fGetDensityMS(target_date,data,results,pnames,nDraws,nParamDraws)
...
for i=1:nParamDraws
    ...
    for nsim=1:nDraws
     ...
     pden_temp = fPredDensityDirect(trend_fit,st_filtered,pmode,FF,MF,1,nDraws,tperiods,hh);

     St_sim_use(:,i) = pden_temp.mean;
