...
for imodel=mymodels
    ...
    for i=1:maxwin
        ...
        xi{i}        = results.xi;                      % support ofPDF ergodic
        xi_good{i}   = results.xi_good;                 % support ofPDF good regime
        xi_bad{i}    = results.xi_bad;                  % support ofPDF bad regime
        cdfi{i}      = results.cdfi;                    % CDF ergodic
        cxi{i}       = results.cxi;                     % support ofCDF ergodic
        ...
        mean(i,1)      = results.quantiles.mean;        % average
        ...
        % Computer counterfactual densities
