...
%
% Comparison between restricted and unrestricted direct model
%=====================================================================
...
for i=myforecasts
    ...
    fig1 = figure;
    figSize1 = [12 6];
    left_scoret_restr = squeeze(QW_CRPS(i,1,7,:));
    left_scoret_unr = squeeze(QW_CRPS(i,2,7,:));
    plot(dates(sd:ed),left_scoret_restr(sd:ed),'Color','k','LineWidth', 2.5); 
    hold on
    plot(dates(sd:ed),left_scoret_unr(sd:ed),'Color',[0.6 0.1 0.1],'LineWidth', 2.5); 
    if opt.dir_or_it==1
    ...
    legend('Restricted','Unrestricted','Orientation','Vertical','Location','Best','interpreter','Latex');legend boxoff;
