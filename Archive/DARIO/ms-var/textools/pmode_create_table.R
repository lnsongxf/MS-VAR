...
texText=cat(paste0("\\documentclass{article}\n",
                   ...
                   paste0("$\\beta_y(s_t)$ & Financial Factor & ",-pmode$a0_3_1_sync_2," & ",-pmode$a0_3_1_sync_1," \\\\\n"),
                   paste0("$\\gamma_y(s_t)$ & Macro Factor & ",-pmode$a0_3_2_sync_2," & ",-pmode$a0_3_2_sync_1," \\\\\n"),
                   paste0("$\\sigma_y(s_t)$ & Shock to GDP & ",pmode$s_3_3_sync_2," & ",pmode$s_3_3_sync_1," \\\\\n"),
                   "\\hline\n",
                   "\\end{tabular}\n",                   
                   "\\end{table}\n",
                   "%</tag>\n",
