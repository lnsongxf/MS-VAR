...
%
%------------------------------------------------------------------
function [out, pden_mat] = fPredDensityIteratedFull_debug(sv,param_in,FF,MF,GDP,trend_fit,opt,temp,modelspec)
...
%     end
    ...
    parfor uu=1:opt.nDraws
        ...
        for tt=1:tperiods
            ...
            [y_temp,y_temp1,y_temp2, s_out_h] = simulate_IteratedFull_debug(st_sim,f_t,m_t,gdp_t,param,opt); 
...
%                 stemp_t(dd,uu,tt) = 0;
%             else
%                 stemp_t(dd,uu,tt) = p12;
%             end
            stemp_t(dd,uu,tt) = s_out_h;
...
out.st_t_mean = mean(stmat_t)';       % This is in t
out.dYsim_25_g  = prctile(y_mat_fut_ex_good,25)';
out.dYsim_75_g  = prctile(y_mat_fut_ex_good,75)';
out.dYsim_10_g  = prctile(y_mat_fut_ex_good,10)';
out.dYsim_90_g  = prctile(y_mat_fut_ex_good,90)';
out.mean_g      = mean(y_mat_fut_ex_good)';
out.dYsim_25_b  = prctile(y_mat_fut_ex_bad,25)';
out.dYsim_75_b  = prctile(y_mat_fut_ex_bad,75)';
out.dYsim_10_b  = prctile(y_mat_fut_ex_bad,10)';
out.dYsim_90_b  = prctile(y_mat_fut_ex_bad,90)';
out.mean_b      = mean(y_mat_fut_ex_bad)';
