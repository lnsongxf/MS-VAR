...
%
%------------------------------------------------------------------
function [out,pden_mat] = fPredDensityDirectFull_mod(sv,param_in,FF,MF,GDP,trend_fit,opt)
...
%             [y_temp,y_temp1,y_temp2] = simulate_DirectFull_struc(st_temp,f_t,m_t,gdp_t,f_t_lag,m_t_lag,gdp_t_lag,param);
