...
opt.save_data      = 1; % 1 = save simulated data
...
for imodel=mymodels
    ...
    if opt.dir_or_it ==1
        ...
        quantfolder   = ['results/Quantiles/' opt.paramsUse '/Simul/Direct/'];
...
%         [quantiles, pdensity, badind] = fPredDensityIteratedFull_debug(sv,params_in,FF_full,MF_full,GDPG_full,TR_full,opt,'forecastst',modelspec);
    end
...
if strcmp(opt.paramsUse,'mode')
    if sim_alg ==1
        if opt.dir_or_it ==1
            ...
            save([quantfolder 'quantiles_direct_alg1.mat'],'quantiles_direct_alg1')
            %         end
        elseif opt.dir_or_it ==2
            ...
            if exist([paramsfolder modelname 'quantiles_iterated_dgp_alg1.mat'],'file')==0 || opt.force_estimate==1
                ...
                [quantiles_iterated_dgp_alg1, pdensity_dgp, badind_dgp] = fPredDensityIteratedFull_dgp(params_in_dgp,FF_full,MF_full,GDPG_full,TR_full,p_reg_good,opt_dgp,'forecastst',4);
                quantiles_iterated_dgp_alg1.GDPG = y_mat(SEED,:); quantiles_iterated_dgp_alg1.GDPGH = y_mat_fut(SEED,:);
                save([quantfolder 'quantiles_iterated_dgp_alg1.mat'],'quantiles_iterated_dgp_alg1')
            end
        end
    elseif sim_alg ==2
        if opt.dir_or_it ==1
            ...
            save([quantfolder 'quantiles_direct_alg2.mat'],'quantiles_direct_alg2')
            %         end
        elseif opt.dir_or_it ==2
            %         if exist([paramsfolder 'quantiles_iterated.mat'],'file')==0 || opt.force_estimate==1
            ...
            %         end
            if exist([quantfolder 'quantiles_iterated_dgp_alg2.mat'],'file')==0 || opt.force_estimate==1
                p_reg_good = st_mat(SEED,:);
                for rr=1:length(p_reg_good); if p_reg_good(rr) ==2; p_reg_good(rr) =0; end; end
                params_in_dgp = dgp;
                params_in_dgp.a0_1_2_sync_1 = (-1)*params_in_dgp.a0_1_2_sync_1;
                ...
                params_in_dgp.a0_3_2_sync_2 = (-1)*params_in_dgp.a0_3_2_sync_2;
                opt_dgp = opt; opt_dgp.nParamDraws = 1;
                [quantiles_iterated_dgp_alg2, pdensity_dgp, badind_dgp] = fPredDensityIteratedFull_dgp(params_in_dgp,FF_full,MF_full,GDPG_full,TR_full,p_reg_good,opt_dgp,'forecastst',4);
                quantiles_iterated_dgp_alg2.GDPG = y_mat(SEED,:); quantiles_iterated_dgp_alg2.GDPGH = y_mat_fut(SEED,:);
                save([quantfolder 'quantiles_iterated_dgp_alg2.mat'],'quantiles_iterated_dgp_alg2')
            end
        end
    end   
end
