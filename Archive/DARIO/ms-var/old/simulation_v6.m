...
% mymodels = [3,4,6,7];
if opt.dir_or_it ==1 % 4 used to be a good one
    mymodels = 8;
elseif opt.dir_or_it ==2 % Correct specification is model 8
    mymodels = 8;
end
...
% FF               = c_1_1             + a1_1_1*FF(-1) + a1_1_2*MF(-1) + a1_1_3*GDP(-1)
% FF s.d.          = s_1_1
% MF               = c_2_1 + a0_2_1*FF + a1_2_1*FF(-1) + a1_2_2*MF(-1) + a1_2_3*GDP(-1)
% MF s.d.          = s_2_2
% GDP, normal      = c_3_1_sync_1 + a0_3_1_sync_1*FF + a0_3_2_sync_1*MF + a1_3_1_sync_1*FF(-1) + a1_3_2_sync_1*MF(-1)
% GDP, normal s.d. = s_3_3_sync_1
% GDP, bad         = c_3_1_sync_2 + a0_3_1_sync_2*FF + a0_3_2_sync_2*MF + a1_3_1_sync_2*FF(-1) + a1_3_2_sync_2*MF(-1)
...
comparison_table_1 = [dgp.c_1_1,dgp.c_1_1,dgp.c_3_1_sync_1;dgp.a0_1_1,-dgp.a0_2_1,-dgp.a0_3_1_sync_1;...
    dgp.a0_1_2,dgp.a0_2_2,-dgp.a0_3_2_sync_1;dgp.a0_1_3,dgp.a0_2_3,dgp.a0_3_3_sync_1;...
    dgp.a1_1_1,dgp.a1_2_1,dgp.a1_3_1_sync_1;dgp.a1_1_2,dgp.a1_2_2,dgp.a1_3_2_sync_1;...
    dgp.a1_1_3,dgp.a1_2_3,dgp.a1_3_3_sync_1;dgp.s_1_1,dgp.s_2_2,dgp.s_3_3_sync_1];
comparison_table_2 = [dgp.c_1_1,dgp.c_1_1,dgp.c_3_1_sync_2;dgp.a0_1_1,-dgp.a0_2_1,-dgp.a0_3_1_sync_2;...
    dgp.a0_1_2,dgp.a0_2_2,-dgp.a0_3_2_sync_2;dgp.a0_1_3,dgp.a0_2_3,dgp.a0_3_3_sync_2;...
    dgp.a1_1_1,dgp.a1_2_1,dgp.a1_3_1_sync_2;dgp.a1_1_2,dgp.a1_2_2,dgp.a1_3_2_sync_2;...
    dgp.a1_1_3,dgp.a1_2_3,dgp.a1_3_3_sync_2;dgp.s_1_1,dgp.s_2_2,dgp.s_3_3_sync_2];
...
[outparams_dgp,~] = scriptParams_FULL(dgp,1,modelspec);
...
for dd=1:rr
    for jj=2:tt
        ...
        f_draw(dd,jj) = dgp.c_1_1 +                          + dgp.a1_1_1*f_draw(dd,jj-1) + dgp.a1_1_2*m_draw(dd,jj-1) + dgp.a1_1_3*y_draw(dd,jj-1) + dgp.s_1_1*eta1(1,1);
        m_draw(dd,jj) = dgp.c_2_1 + dgp.a0_2_1*f_draw(dd,jj) + dgp.a1_2_1*f_draw(dd,jj-1) + dgp.a1_2_2*m_draw(dd,jj-1) + dgp.a1_2_3*y_draw(dd,jj-1) + dgp.s_2_2*eta1(2,1);
        ...
        if st_temp==2
            y_draw(dd,jj) = dgp.c_3_1_sync_2 + dgp.a0_3_1_sync_2*f_draw(dd,jj) + dgp.a0_3_2_sync_2*m_draw(dd,jj) + dgp.a1_3_1_sync_2*f_draw(dd,jj-1) + dgp.a1_3_2_sync_2*m_draw(dd,jj-1) + dgp.s_3_3_sync_2*eta2;
        else
            y_draw(dd,jj) = dgp.c_3_1_sync_1 + dgp.a0_3_1_sync_1*f_draw(dd,jj) + dgp.a0_3_2_sync_1*m_draw(dd,jj) + dgp.a1_3_1_sync_1*f_draw(dd,jj-1) + dgp.a1_3_2_sync_1*m_draw(dd,jj-1) + dgp.s_3_3_sync_1*eta2;
        end
...
SEED = 555;
    ...
    % ==========================================================================
%     if bad ==1
%         st_t_mean_temp = 1/quantiles.st_t_mean;
%     elseif bad ==2
        st_t_mean_temp = quantiles.st_t_mean;
%     end
...
if strcmp(opt.paramsUse,'mode')
    if opt.dir_or_it ==1
        ...
        % Load results or estimate posterior mode
        if exist([paramsfolder 'quantiles_direct.mat'],'file')==0 || opt.force_estimate==1
            quantiles_direct = quantiles;
            save([paramsfolder 'quantiles_direct.mat'],'quantiles_direct')
        end
    elseif opt.dir_or_it ==2
        % Load results or estimate posterior mode
%         if exist([paramsfolder 'quantiles_iterated.mat'],'file')==0 || opt.force_estimate==1
            quantiles_iterated = quantiles;
            save([paramsfolder 'quantiles_iterated.mat'],'quantiles_iterated')
%         end
    end
    if exist('results/Params/mode/Simul/Direct/quantiles_direct.mat','file')==2 && exist('results/Params/mode/Simul/Iterated/quantiles_iterated.mat','file')==2
    ...
    hold off
    ylabel('Percent','interpreter','Latex','fontsize',10)
        title('Quantiles Direct and Iterated','Interpreter','Latex','FontSize',16);
