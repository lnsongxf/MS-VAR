...
for imodel=mymodels
    ...
    target_dates = [...%datenum('2020-Jan',dataformat),...
        ...
        datenum('2007-Oct',dataformat)
        datenum('2008-Oct',dataformat)
...
%         datenum('2020-Apr',dataformat)
    ...
    if opt.dir_or_it ==1
        ...
        varlist={'FF','MF','GDPGH'}';
        % Folders
        paramsfolder = ['results/Params/' opt.paramsUse '/Full/Direct_Q/'];
        %texfolder   = ['results/Params/' opt.paramsUse '/Direct/Tex_Q/'];
        figfolder   = ['results/Figures/' opt.paramsUse '/Full/Direct_Q/' spectag '/'];
        
    elseif opt.dir_or_it ==2
        fcstype= 'iterated';
        varlist={'FF','MF','GDPG'}';
        % Folders
        paramsfolder = ['results/Params/' opt.paramsUse '/Full/Iterated_Q/'];
        %texfolder   = ['results/Params/' opt.paramsUse '/Iterated/Tex_Q/'];
        figfolder   =  ['results/Figures/' opt.paramsUse '/Full/Iterated_Q/' spectag '/'];
    end
    ...
    dates_full = datenum((datetime(start_date,'InputFormat',inputformat))+calquarters(nlags):calquarters(1):(datetime(end_date,'InputFormat',inputformat)))';
    ...
    [db, db_full,startdb,enddb,tex] = fLoadDataQ(datafilename,sheetuse,start_date,end_date,opt.hh);
    ...
    if nlags==1
        ...
        outparams = scriptParams_FULL_companion(sv,params_in);
    end
