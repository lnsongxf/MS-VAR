...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-1.2 -0.9 -0.6 -0.3 0 0.3])
axis([0 60 -1.2 0.3])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-1.5 -1 -0.5 0 0.5 1])
axis([0 60 -1.5 1])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
...
print -dpng  'restrictions_1_and_2_with_psi_pc_equal_0_1965m1_2007m6_IP_CPI.png'
