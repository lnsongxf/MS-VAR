...
set(gca,'YTick',[-1 -0.75 -0.5 -0.25 0 0.25 0.5 0.75])
axis([0 60 -1 0.75])
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-1.5 -1.2 -0.9 -0.6 -0.3 0 0.3 0.6 0.9])
axis([0 60 -1.5 0.9])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
...
print -dpng  'restrictions_1_and_2_with_bounds_1965m1_2007m6_IP_CPI.png'
