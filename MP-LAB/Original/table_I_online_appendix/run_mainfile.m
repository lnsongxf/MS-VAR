...
disp('----------------------------------------------------------')
disp('**********************************************************')
disp('************************* Table I Online Appendix ***************')
disp('**********************************************************')
disp('----------------------------------------------------------')
cd ..
gcd = pwd;
eval(['load ',gcd,'/figure_4_panel_b/results/results.mat']);
cd table_I_online_appendix
...
format bank
disp('****************** Table I Online Appendix: Restrictions 1 2 and 3 ******************')
...
disp('ssigma: 50-th Quantile')
disp(quantile(ssigma,0.5))
disp('ssigma: 16-th Quantile and 84-th Quantile')
disp([quantile(ssigma,0.16),quantile(ssigma,0.84)])
disp('ssigma: 2.5-th Quantile and 97.5-th Quantile')
disp([quantile(ssigma,0.025),quantile(ssigma,0.975)])
...
format bank
disp('****************** Table I Online Appendix: Restrictions 2 and 3 ******************')
disp('Fed Funds Rate Contemporaneous Response to Output: 50-th Quantile')
disp(quantile(ppsiy,0.5))
disp('Fed Funds Rate Contemporaneous Response to Output: 16-th Quantile and 84-th Quantile')
disp([quantile(ppsiy,0.16),quantile(ppsiy,0.84)])
