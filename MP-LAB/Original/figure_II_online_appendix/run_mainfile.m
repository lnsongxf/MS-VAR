...
nd        = 1e5; %1e5                % number of orthogonal-reduced-form (B,Sigma,Q) draws
iter_show = 1e4; %1e4                % display iteration every iter_show draws
...
OomegaTildeInverse  = (OomegaTildeInverse'+OomegaTildeInverse)*0.5;
