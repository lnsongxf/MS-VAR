...
set(gca,'YTick',[-1.2 -0.8 -0.4 0 0.4 0.8 1.2])
axis([0 60 -1.2 1.2])
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-2.25 -1.5 -0.75 0 0.75])
axis([0 60 -2.25 0.75])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
...
print -dpng  'restrictions_1_and_2_in_first_differences_1965m1_2007m6_IP_CPI.png'
