...
num  = [100*diff(log(data.IP)) 100*diff(log(data.CPIAUCSL)) 100*diff(log(data.CPRINDEX)) 100*diff(log(data.TRARR)) 100*diff(log(data.BOGNONBR)) data.FEDFUNDS(2:end,1)];
