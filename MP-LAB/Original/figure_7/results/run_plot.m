...
close all
hFig = figure(1);
set(hFig, 'Position', [20 20 750 200])
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-1.6 -1.2 -0.8 -0.4 0 0.4 0.8])
axis([0 60 -1.6-0.4/4 0.8])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
set(gca,'LineWidth',ftlinewidth)
title(' GDP Deflator','FontSize',ftsizetitle)
box on
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth )
set(gca,'YTick',[-0.5 -0.25 0 0.25 0.5 0.75])
axis([0 60 -0.5-0.25/4 0.75])
xlabel('Years','FontSize',ftsizexlabel)
...
print -dpng  'restrictions_1_and_2_in_first_differences_1965m1_2007m6_3_panels.png'
...
hline(0,'-r')
hold on
%plot(0:1:H,squeeze(Ltildeq025(:,1,1)),':','LineWidth',medianwidth,'color',rgb('royalblue'))
%hold on
%plot(0:1:H,squeeze(Ltildeq975(:,1,1)),':','LineWidth',medianwidth,'color',rgb('royalblue'))
%hold on
a=(squeeze(Ltildeq16(:,1,1)))';
b=(squeeze(Ltildeq84(:,1,1)))';
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-5 -2.5 0 2.2 5])
axis([0 60 -5-2/4 5+2/4])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
set(gca,'LineWidth',ftlinewidth)
...
set(gca,'XTickLabel',['0 ';' 1';' 2';' 3';' 4';' 5'])
set(gca,'LineWidth',ftlinewidth)
set(gca,'YTick',[-2.25 -1.5 -0.75 0 0.75 1.5])
axis([0 60 -2.25 1.5+0.5/4])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
set(gca,'LineWidth',ftlinewidth)
...
print -dpng  'restrictions_1_and_2_in_first_differences_1965m1_2007m6.png'
