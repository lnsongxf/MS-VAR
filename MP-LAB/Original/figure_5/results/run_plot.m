...
axis([0 60 -0.9-0.25/4 0.3+0.25/4])
xlabel('Years','FontSize',ftsizexlabel)
ylabel('Percent','FontSize',ftsizexlabel)
set(gca,'FontSize',ftsizeaxis)
set(gca,'LineWidth',ftlinewidth)
...
axis([0 60 -0.5-0.25/4 0.75+0.25/4])
xlabel('Years','FontSize',ftsizexlabel)
...
print -dpng  'restrictions_1_and_2_with_psi_pc_equal_0_1965m1_2007m6_3_panels.png'
...
print -dpng  'restrictions_1_and_2_with_psi_pc_equal_0_1965m1_2007m6.png'
