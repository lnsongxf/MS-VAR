...
data   = data(1:find(strcmp(data.dates,'2003-12-01')==1),:);
...
nd        = 3e5;                 % number of orthogonal-reduced-form (B,Sigma,Q) draws
...
horizons  = 0:5;                 % horizons to restrict
...
S{1}(1,nvar+2) = -1;S{1}(5,2*nvar+2)  = -1;S{1}(9,3*nvar+2)  = -1;S{1}(13,4*nvar+2) = -1;S{1}(17,5*nvar+2) = -1;S{1}(21,6*nvar+2) = -1;
S{1}(2,nvar+3) = -1;S{1}(6,2*nvar+3)  = -1;S{1}(10,3*nvar+3) = -1;S{1}(14,4*nvar+3) = -1;S{1}(18,5*nvar+3) = -1;S{1}(22,6*nvar+3) = -1;
S{1}(3,nvar+5) = -1;S{1}(7,2*nvar+5)  = -1;S{1}(11,3*nvar+5) = -1;S{1}(15,4*nvar+5) = -1;S{1}(19,5*nvar+5) = -1;S{1}(23,6*nvar+5) = -1;
S{1}(4,nvar+6) =  1;S{1}(8,2*nvar+6)  =  1;S{1}(12,3*nvar+6) =  1;S{1}(16,4*nvar+6) =  1;S{1}(20,5*nvar+6) =  1;S{1}(24,6*nvar+6) =  1;
